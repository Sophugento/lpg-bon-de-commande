...
export const PRODUCT_INFO: Record<string, ProductInfo> = {
  ...
  // ── TEXTILES ───────────────────────────────────────────────────────────
  "TUNIQUE NOIRE — S/36": {
    description: "Tunique professionnelle LPG noire — taille S/36.",
    descriptionDe: "Professionelle schwarze LPG-Tunika — Größe S/36.",
  ...
  "TUNIQUE NOIRE — M/38": {
    description: "Tunique professionnelle LPG noire — taille M/38.",
    descriptionDe: "Professionelle schwarze LPG-Tunika — Größe M/38.",
    benefits: ["Coupe enveloppante", "Matière fluide", "Badge LPG brodé"],
    benefitsDe: ["Fließendes Material", "Eingehüllter Schnitt", "Besticktes LPG-Badge"],
    imageUrl: "/images/products/tunique_noire.png",
  },
  "TUNIQUE NOIRE — L/40": {
    description: "Tunique professionnelle LPG noire — taille L/40.",
    descriptionDe: "Professionelle schwarze LPG-Tunika — Größe L/40.",
    benefits: ["Coupe enveloppante", "Matière fluide", "Badge LPG brodé"],
    benefitsDe: ["Fließendes Material", "Eingehüllter Schnitt", "Besticktes LPG-Badge"],
    imageUrl: "/images/products/tunique_noire.png",
  },
  "TUNIQUE NOIRE — XL/42": {
    description: "Tunique professionnelle LPG noire — taille XL/42.",
    descriptionDe: "Professionelle schwarze LPG-Tunika — Größe XL/42.",
    benefits: ["Coupe enveloppante", "Matière fluide", "Badge LPG brodé"],
    benefitsDe: ["Fließendes Material", "Eingehüllter Schnitt", "Besticktes LPG-Badge"],
    imageUrl: "/images/products/tunique_noire.png",
  },
  "TUNIQUE BLANCHE — S/36": {
    description: "Tunique professionnelle LPG blanche — taille S/36.",
    descriptionDe: "Professionelle weiße LPG-Tunika — Größe S/36.",
    benefits: ["Coupe enveloppante", "Matière fluide", "Badge LPG brodé"],
    benefitsDe: ["Fließendes Material", "Eingehüllter Schnitt", "Besticktes LPG-Badge"],
    imageUrl: "/images/products/tunique_blanche.jpg",
  },
  "TUNIQUE BLANCHE — M/38": {
    description: "Tunique professionnelle LPG blanche — taille M/38.",
    descriptionDe: "Professionelle weiße LPG-Tunika — Größe M/38.",
    benefits: ["Coupe enveloppante", "Matière fluide", "Badge LPG brodé"],
    benefitsDe: ["Fließendes Material", "Eingehüllter Schnitt", "Besticktes LPG-Badge"],
    imageUrl: "/images/products/tunique_blanche.jpg",
  },
  "TUNIQUE BLANCHE — L/40": {
    description: "Tunique professionnelle LPG blanche — taille L/40.",
    descriptionDe: "Professionelle weiße LPG-Tunika — Größe L/40.",
    benefits: ["Coupe enveloppante", "Matière fluide", "Badge LPG brodé"],
    benefitsDe: ["Fließendes Material", "Eingehüllter Schnitt", "Besticktes LPG-Badge"],
    imageUrl: "/images/products/tunique_blanche.jpg",
  },
  "TUNIQUE BLANCHE — XL/42": {
    description: "Tunique professionnelle LPG blanche — taille XL/42.",
    descriptionDe: "Professionelle weiße LPG-Tunika — Größe XL/42.",
    benefits: ["Coupe enveloppante", "Matière fluide", "Badge LPG brodé"],
    benefitsDe: ["Fließendes Material", "Eingehüllter Schnitt", "Besticktes LPG-Badge"],
    imageUrl: "/images/products/tunique_blanche.jpg",
  },
  ...
  "ENDERMOWEAR BLANC — T.1 / M": {
    description: "Combinaison Endermowear blanche — taille 1 / M.",
    descriptionDe: "Weiße Endermowear-Kombination — Größe 1 / M.",
  ...
  "ENDERMOWEAR BLANC — T.2 / L": {
    description: "Combinaison Endermowear blanche — taille 2 / L.",
    descriptionDe: "Weiße Endermowear-Kombination — Größe 2 / L.",
    benefits: ["Tissu technique breveté", "Optimise l'efficacité du soin", "Usage cabine"],
    benefitsDe: ["Patentierter Technologiestoff", "Optimiert die Behandlungseffizienz", "Kabinengebrauch"],
    imageUrl: "/images/products/conso_ENDERMOWEAR_center_01.png",
  },
  "ENDERMOWEAR BLANC — T.3 / XL": {
    description: "Combinaison Endermowear blanche — taille 3 / XL.",
    descriptionDe: "Weiße Endermowear-Kombination — Größe 3 / XL.",
    benefits: ["Tissu technique breveté", "Optimise l'efficacité du soin", "Usage cabine"],
    benefitsDe: ["Patentierter Technologiestoff", "Optimiert die Behandlungseffizienz", "Kabinengebrauch"],
    imageUrl: "/images/products/conso_ENDERMOWEAR_center_01.png",
  },
  "ENDERMOWEAR BLANC — T.4 / XXL": {
    description: "Combinaison Endermowear blanche — taille 4 / XXL.",
    descriptionDe: "Weiße Endermowear-Kombination — Größe 4 / XXL.",
    benefits: ["Tissu technique breveté", "Optimise l'efficacité du soin", "Usage cabine"],
    benefitsDe: ["Patentierter Technologiestoff", "Optimiert die Behandlungseffizienz", "Kabinengebrauch"],
    imageUrl: "/images/products/conso_ENDERMOWEAR_center_01.png",
  },
  ...
  "PEIGNOIR 100% COTON — M": {
    description: "Peignoir 100% coton LPG — taille M.",
    descriptionDe: "Bademantel 100% Baumwolle LPG — Größe M.",
  ...
  "PEIGNOIR 100% COTON — L": {
    description: "Peignoir 100% coton LPG — taille L.",
    descriptionDe: "Bademantel 100% Baumwolle LPG — Größe L.",
    benefits: ["100% coton doux", "Marquage LPG brodé", "Confort optimal"],
    benefitsDe: ["100% weiche Baumwolle", "Eingesticktes LPG-Logo", "Optimaler Komfort"],
    imageUrl: "/images/products/peignoir.jpg",
  },
  "PEIGNOIR 100% COTON — XL": {
    description: "Peignoir 100% coton LPG — taille XL.",
    descriptionDe: "Bademantel 100% Baumwolle LPG — Größe XL.",
    benefits: ["100% coton doux", "Marquage LPG brodé", "Confort optimal"],
    benefitsDe: ["100% weiche Baumwolle", "Eingesticktes LPG-Logo", "Optimaler Komfort"],
    imageUrl: "/images/products/peignoir.jpg",
  },
