...
export const PRODUCT_INFO: Record<string, ProductInfo> = {
  ...
  "TUNIQUE NOIRE — S/36": {
    ...
    benefits: ["Coupe enveloppante", "Matière fluide", "Coloris noir"],
  ...
  "TUNIQUE BLANCHE — S/36": {
    ...
    benefits: ["Coupe enveloppante", "Matière fluide", "Coloris blanc"],
    benefitsDe: ["Fließendes Material", "Eingehüllter Schnitt", "Farbe Weiß"],
